...
st.markdown("""
    <div>
        <h4>Problems to Solve with the Project</h4>
...
st.markdown("""
    <div>
        ...
        <h4>Benefits of Seismic Wave Exploration</h4>
        <div style="display: flex; align-items: flex-start; justify-content: space-between;">
        <div style="flex: 1; margin-right: 30px;">
            <figure>
    ...
    <p><b>1. Understanding the Internal Structure of Celestial Bodies</b></p>
    ...
    <p><b>2. Providing Basic Data for Exploration</b></p>
    ...
    <p><b>3. Researching Planetary Evolution and Formation Processes</b></p>
