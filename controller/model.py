...
def load_h5_model():
    try:
        # 모델 파일이 존재하는지 확인
        if not os.path.exists('home/yang1115/space_apps/event_time_finder.h5'):
            raise FileNotFoundError('Model does not exist')
        
        # 모델 로드
        model = tf.keras.models.load_model(
            'home/yang1115/space_apps/event_time_finder.h5', 
...
def predict_classification(velocity, sampling_rate):
    ...
    model_classification = load_pth_model('home/yang1115/space_apps/original_seismic_classifier.pth')
